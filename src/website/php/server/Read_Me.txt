...
This is a simple script to help you get TrackMe running on your own server. I take no credit for any of the work done on TrackMe, an application built by staryon on XDA Developers. You can download the most recent version of these files and the installer for Windows Mobile from the XDA Forum thread located here: http://forum.xda-developers.com/showthread.php?t=340667
...
Thanks again to staryon for developing and maintaining the application and for taking comments and feedback to drive his development.