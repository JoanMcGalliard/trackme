<?php
    ...
    else
    {
        ...
        if ($empty_users[0] < 1 || $empty_trips[0] < 1 || $empty_positions[0] < 1 || $empty_icons[0] < 1)
        {
			...
			$html .= "            <link rel=\"shortcut icon\" href=\"favicon.ico\">\n";
            $html .= "            <title>$title_text (v" . $version_text . ")</title>\n";
            $html .= "            <script src=\"http://maps.google.com/maps?file=api&amp;v=2.x&amp;key=$googleapikey\" type=\"text/javascript\"></script>\n";
			$html .= "        </head>\n";
            $html .= "        <body bgcolor=\"$bgcolor\">\n";
            $html .= "            <div align=center>\n";
        ...
        else
        {
            ...
            elseif($public_page != "yes" && isset($_COOKIE["ID"]) && isset($_COOKIE["username"]) && isset($_COOKIE["password"]))
            {
                $loggedin = "yes";
                $ID       = $_COOKIE["ID"];
            ...
            elseif($public_page != "yes" && isset($username) && isset($password))
            {
...
if(isset($_REQUEST[last_location]))   //if we are in live tracking then display this in center
      {
		...
		$html .= "                 $trip_title<br>\n";
                $html .= "                        <select name=\"trip\" class=\"pulldownlayout\" onchange=\"javascript:submittrip();\" >\n";
                $tripname = $trip;
...
sa.com/central_eng.php\">Luis Espinosa</a></div>/n";
                ...
                $html .= "                iconRed.image = 'http://maps.google.com/mapfiles/ms/micons/red-dot.png';\n";
                $html .= "                iconRed.shadow = 'http://maps.google.com/mapfiles/ms/micons/msmarker.shadow.png';\n";
                ...
                $html .= "                iconLtBlue.image = 'http://labs.google.com/ridefinder/images/mm_20_gray.png';\n";
                $html .= "                iconLtBlue.shadow = 'http://labs.google.com/ridefinder/images/mm_20_shadow.png';\n";
                ...
                $html .= "                iconGreen.image = 'http://maps.google.com/mapfiles/ms/micons/green-dot.png';\n";
                $html .= "                iconGreen.shadow = 'http://maps.google.com/mapfiles/ms/micons/msmarker.shadow.png';\n";
