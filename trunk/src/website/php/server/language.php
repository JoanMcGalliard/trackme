<?php
	...
	$location_button_text_off            	= "Live Tracking Off";
        ...
        $filter_photo_comment_text           	= "Photo und Kommentar";
        ...
        $display_options_title_text          	= "Eigene Display Einstellungen";
	...
	$location_button_text 			= "Volg live";
	$location_button_text_off            	= "Live Tracking Off";
	...
	$filter_comment_text 			= "Commentaar punten";
	$filter_last_20 			= "Laatste 20 punten";
	$filter_daterange 			= "Datum bereik";
	$footer_text 				= "Tracking informatie verzorgd door ";
	$incomplete_install_text 		= "Installatie niet volledig uitgevoerd! De files install.php en database.sql bestaan in de TrackMe map. Delete install.php en database.sql uit de TrackMe map om gebruikt te maken van Trackme.";
	...
	$database_fail_text 			= "Verbinding maken met database mislukt. Weergeven afgebroken.";
        $trip_none_text                      	= "None";
        $trip_any_text                          = "Any";
	$display_options_title_text 		= "Instelbare display opties";
	$display_header_text 			= "Display Header";
	$display_showbearing_text		= "Display Bearing Arrows";
	$display_crosshair_text 		= "Toon crosshair";
	$display_clickcenter_text 		= "Klik naar middelpunt";
	...
	$summary_comments 			= "Aantal commentaren:";
	// Public Display Information
